...
params = dict(service='WFS',version='2.0.0',request='GetFeature',typeName='500m_mesh_2018_13.shp',outputFormat='json')
...
join=gpd.sjoin(geodata,pop,how="inner",op="interesects")
